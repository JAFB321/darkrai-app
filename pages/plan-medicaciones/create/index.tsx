import { PlanMedicacionCreate } from "@components/plan-medicacion/PlanMedicacionCreate";
...
export default function PlanMedicacionCreatePlan() {
  return <PlanMedicacionCreate />;
